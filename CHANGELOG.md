...
## [11.5.0]
### Added
- [Not user facing?] Adopt new version of `@metamask/signature-controller` to add signature operation logs ([#21207)](https://github.com/MetaMask/metamask-extension/pull/21207))
...
- [Not user facing?] Remove unused KeyringLabel ([#21446)](https://github.com/MetaMask/metamask-extension/pull/21446))
